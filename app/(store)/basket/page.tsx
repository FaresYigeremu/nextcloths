...
function BasketPage() {
    ...
    const handleCheckout = async () => {
        ...
        try{
            const metadata: Metadata = {
                orderNumber: crypto.randomUUID(), // i.e;- aslh23lkj-asdlfk
    ...
    // console.log("BASKET CONTENT", groupedItems)
  return (
        ...
        <div className="flex flex-col lg:flex-row gap-8">
                ...
                {groupedItems?.map((item) => (
                    ...
                    className="mb-4 p-4 border rounded flex items-center justify-between">
                        ...
                        className="flex items-center ml-4 flex-shrink-0">
                            <AddToBasketButton product={item.product} /></div>
                    </div>
                ))}
            </div>
            ...
            <div className="w-full lg:w-80 lg:sticky lg:top-4 h-fit bg-white p-6 border rounded order-first lg:order-last fixed bottom-0 left-0 lg:left-auto">
                ...
                {isSignedIn ? (
                    ...
                    disabled={isLoading}
                    className="mt-4 w-full bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 disabled:bg-gray-400"
                    >
            ...
            <div className="h-64 lg:h-0">
                {/**Space for fixed checkout on phone */}
            </div>
        </div>
    </div>
  )
