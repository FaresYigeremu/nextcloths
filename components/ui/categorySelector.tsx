...
export function CategorySelectorComponent({
    ...
    <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
            ...
            role="combobox"
            aria-expanded={open}
            className="w-full max-w-full relative flex justify-center sm:justify-start sm:flex-none items-center space-x-2 bg-red-500 hover:bg-red-700 hover:text-white text-white font-bold py-2 px-4 rounded">
