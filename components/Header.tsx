  ...
  return (
    <header className="flex flex-wrap justify-between items-center px-4 py-2">
        ...
        <div className="flex w-full flex-wrap justify-between items-center">
            <Link href= "/"
            className="text-2xl font-bold text-red-500 hover:opacity-50 cursor-pointer mx-auto sm:mx-0">
                NextCloth
            </Link>
            <Form action="/search" 
            className="w-full sm:w-auto sm:flex-1 sm:mx-4 mt-2 sm:mt-0">
                ...
                className="w-full bg-gray-100 text-gray-800 px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 border  max-w-4xl
                "/>
            </Form>
